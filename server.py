    ...
    if request.method == 'POST':
        ...
        if mp_amm == '1':
            if request.form.get(f'message_parameter{0}_regex') == 'True':
                message_parameter[request.form.get(f'message_parameter{0}_name')] = re.compile(request.form.get(f'message_parameter{0}_value')).pattern
            else:
            ...
            for i in range(int(mp_amm)):    
                if request.form.get(f'message_parameter{i}_regex') == 'True':
                    message_parameter[request.form.get(f'message_parameter{i}_name')] = re.compile(request.form.get(f'message_parameter{i}_value')).pattern
                else:
        ...
        if pp_amm == '1':
            if request.form.get(f'pagination_parameter{0}_regex') == 'True':
                pagination_parameter[request.form.get(f'pagination_parameter{0}_name')] = re.compile(request.form.get(f'pagination_parameter{0}_value')).pattern
            else:
            ...
            for i in range(int(pp_amm)):
                if request.form.get(f'pagination_parameter{i}_regex') == 'True':
                    pagination_parameter[request.form.get(f'pagination_parameter{i}_name')] = re.compile(request.form.get(f'pagination_parameter{i}_value')).pattern
                else:
        ...
        if tp_amm == '1':
            if request.form.get(f'thread_post_parameter{0}_regex') == 'True':
                thread_post_parameter[request.form.get(f'thread_post_parameter{0}_name')] = re.compile(request.form.get(f'thread_post_parameter{0}_value')).pattern
            else:
        ...
        if ftp_amm == '1':
            if request.form.get(f'forum_threads_parameter{0}_regex') == 'True':
                forum_threads_parameter[request.form.get(f'forum_threads_parameter{0}_name')] = re.compile(request.form.get(f'forum_threads_parameter{0}_value')).pattern
            else:
